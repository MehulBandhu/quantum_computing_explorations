...
pdb_ca = np.array([
    [19.547, 28.635, 14.257],  # L
    [20.016, 25.021, 13.347],  # H
    [21.946, 23.140, 16.088],  # P
    [20.141, 20.010, 17.109],  # G
    [16.413, 20.506, 17.463],  # A
    [15.222, 22.063, 14.154],  # G
    [11.711, 23.276, 14.644],  # K
])
